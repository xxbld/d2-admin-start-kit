...
import d2Log, { d2LogModule } from '@/store/modules/d2admin/modules/log'
export default {
  computed: {
    logLength: () => d2LogModule.length,

    logLengthError: () => d2LogModule.lengthError,
