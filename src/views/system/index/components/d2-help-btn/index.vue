<template>
  <div>
    <img src="./image/d2-help-button@2x.png" style="width: 138px;" @click="handleClickVisible" />
    <el-dialog title="帮助" width="600px" :visible.sync="dialogVisible" :append-to-body="true">
